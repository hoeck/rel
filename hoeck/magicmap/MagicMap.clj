...
(clojure.core/ns hoeck.magicmap.MagicMap
...
(library/eval-when (library/class-exists? 'hoeck.magicmap.MagicMap)
...
(defn- -withMeta
  [this meta-data]
  (hoeck.magicmap.MagicMap. (assoc (prop) :meta meta-data)))
...
(defn- -empty
  [this]
  (hoeck.magicmap.MagicMap. (-> this .theMap .empty)))
...
;; (require 'hoeck.magicmap.MagicMap :reload)
;; (binding [*compile-path* "/home/timmy-turner/clojure/classes"] (compile 'hoeck.magicmap.MagicMap))
