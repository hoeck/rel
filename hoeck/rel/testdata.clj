...
(def index-S
     '{:city {rostock #{{:id 102, :city rostock, :street plattenbauweg}}, dresden #{{:id 101, :city dresden, :street plattenbauweg} {:id 100, :city dresden, :street fickpieschener-allee} {:id 103, :city dresden, :street bighaynstr}}}
